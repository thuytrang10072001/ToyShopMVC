	...
	<div id="wrapper">
		...
		<form:form action="create.htm" modelAttribute="product" method="POST" 
			...
			<div class="row_1" style="    margin-top: 56px;">
			  ...
			  <div class="" style="width: 191px;">
			  <label
				class="labels" style="">Nước sản xuất:</label><form:select path="nuocsx" items="${nuoc}"  style="height: 35px"
			...
			<div class="row_2">
			 ...
			 <label
				class="labels">Đơn giá:</label><form:input placeholder="Vui lòng nhập tên đơn giá" class="input_order form-control" path="dongia"
				type="number" value=""/>
			 ...
			 <div class="" style="width: 350px;">
			  <label class="labels">Mô
				tả</label>
			<form:textarea placeholder="Nhập mô tả tại đây"   class="input_order form-control" path="mota" />
			
			</div>
			</div>
			<div class="row_3">
			<div class="">
			<label class="labels">Số lượng tồn:</label><form:input placeholder="Vui lòng nhập số lượng tồn" class="input_order form-control" path="soluongton"
				type="number" value="" /> 
				<form:errors path="soluongton"/>
			</div>	
			<div class="">
			<label class="labels">hình
				ảnh:</label><form:input placeholder="Vui lòng chọn hình ảnh" class="input_order form-control" type="text"  value="" path="hinhanh"/>
				</div>
				<div class="">
				<label class="labels" style="width: 191px;">Loại sản phẩm:</label><form:select path="loaisp" items="${loaisps}"  style="height: 36px"
				class="input_order form-control">
				</form:select>
