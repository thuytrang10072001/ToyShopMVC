	...
	<div id="wrapper">
		...
		<form:form action="update.htm" modelAttribute="product" method="POST" 
			...
			<div class="body-form">
			  ...
			  <div class="" style="width: 191px;">
			  <label
				class="labels">Nước sản xuất:</label><form:select path="nuocsx" items="${nuoc}"  style="height: 35px"
			...
			<div class="row_2">
			 ...
			 <label
				class="labels">Đơn giá:</label><form:input placeholder="Vui lòng nhập đơn giá" class="input_order form-control" path="dongia"
				type="number" value=""/>
			 ...
			 <div class="" style="width: 350px;">
			  <label class="labels">Mô
				tả</label>
			<form:textarea placeholder="Nhập mô tả tại đây" rows="4" cols="10" class="input_order form-control" path="mota" />
			...
			<label class="labels">hình
				...
				<div class="" style="width: 191px;">
				<label class="labels">Loại sản phẩm:</label><form:select path="loaisp" items="${loaisps}"  style="height: 36px"
				class="input_order form-control">
				</form:select>
