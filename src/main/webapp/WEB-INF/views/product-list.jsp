	...
	<div class="product-grid padding-top100">
		<div class="container">
			<div class="row block-filter">
				...
				<div class="col-md-2 col-sm-6 col-xs-12">
					<div class="btn-group grid-list-btn">
						<a class="btn btn-default active" id="list-view"
							onclick="clickButton('productList')"><i class="fa fa-th-list"></i></a>
						<a class="btn btn-default " id="grid-view"
			...
			<div class="row padding-top100">
				...
				<c:url value="product/productList/index.htm" var="pagedLink">
								...
								<div class="col-md-9 col-sm-8 col-xs-8 width-100">
									<div class="aside">
										<div class="caption_inside">
											<div class="name">
												<a href="single-product.htm">${p.tenSP}</a>
											</div>
											...
											<div class="rating">
												...
												</span> <span class="fa-stack"> <i
													class="fa fa-star fa-stack-1x"></i></span> <span class="fa-stack"><i
													class="fa fa-star fa-stack-1x"></i></span> <span class="fa-stack"><i
													class="fa fa-star fa-stack-1x"></i></span> <span class="fa-stack"><i
