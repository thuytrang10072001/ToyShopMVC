...
public class NhanVienController {
			...
			@RequestParam("NewPassword") String newpass,@RequestParam("Reppassword") String reppass) throws NoSuchAlgorithmException
	{
		...
		// bắt validation ở đây gồm mật khẩu k giống trong database sử dụng thằng LoginController.taikhoan so sánh
	...
	/*
	 * @RequestMapping("NV/acceptChange") public String acceptpass(ModelMap model,)
	 */
